...
import { Search, Leaf, ArrowLeft } from "lucide-react";
...
export default function AllCropsSection() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <motion.section
        className="relative bg-gradient-to-br from-primary-600 to-primary-800 text-white py-20 md:py-28 overflow-hidden"
        initial="hidden"
        animate="visible"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white/90 max-w-3xl mx-auto leading-relaxed">
              ...
              fitosanitarias específicas para cada uno.
            </p>
          </motion.div>
        </div>
      </motion.section>
              ...
              {filteredCrops.map((crop, index) => (
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      backgroundImage: `linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.6)), url(${crop.backgroundImage})`,
                    }}
                  />
                  ...
                  <div className="relative z-10 h-full flex flex-col">
                    ...
                    <div className={`flex-1 flex items-center justify-center transition-all duration-300 ${
                      hoveredCard === index ? 'opacity-20' : 'opacity-100'
                    }`}>
                      <Image
                    ...
                    >
                      ...
                      <Link
                        ...
                        className="mt-4 bg-primary-600 hover:bg-primary-700 text-white px-4 py-2 rounded-lg font-semibold text-center transition-colors inline-block"
                      >
                        Ver Detalles
                      </Link>
                    </motion.div>
