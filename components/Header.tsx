...
export default function Header() {
    ...
    useEffect(() => {
        const handleScroll = () => {
            ...
            setScrolledPastHero(currentScrollY > heroHeight)
    ...
    return (
        <motion.header
            ...
            className={cn(
                "w-full fixed top-0 z-50 flex items-center justify-between px-4 py-4 md:px-10 md:py-5 lg:px-64 lg:py-6",
                scrolledPastHero ? "bg-white shadow-sm" : "bg-transparent",
                scrolledPastHero ? "text-gray-800" : "text-white",
                "transition-all",
            )}
        >
                    ...
                    <li key={item.id}>
                        <a
                            ...
                            className={cn(
                                ...
                                scrolledPastHero ? "hover:text-green-600" : "hover:text-gray-300",
            ...
            <div className="md:hidden">
                ...
                <motion.div
                    ...
                    className={cn(
                        "fixed inset-0 flex flex-col items-center justify-center space-y-8 text-2xl",
                        scrolledPastHero ? "bg-white text-gray-800" : "bg-black bg-opacity-90 text-white",
                    )}
